...
export default {
  data() {
    return {
      ...
      allTableData: [
        [
          { name: "说明", userName: "spongebob", updateTime: "2018-04-13", type: '文件夹' ,needpower:1},
          { name: "普通资料1", userName: "forg", updateTime: "2018-04-12", type: '文件夹'  ,needpower:1},
          { name: "普通资料2", userName: "forg", updateTime: "2018-04-13", type: '文件夹'  ,needpower:1},
          { name: "普通资料3", userName: "wanghoulun", updateTime: "2018-04-10", type: '文件夹'  ,needpower:1},
          { name: "普通资料4", userName: "fanping", updateTime: "2018-04-10", type: '文件夹'  ,needpower:1},
          { name: "普通资料4", userName: "zhoujiel", updateTime: "2018-04-11", type: '文件夹'  ,needpower:1},
          { name: "普通资料4", userName: "spongebob", updateTime: "2018-04-12", type: '文件夹'  ,needpower:1},
        ],
        [
          { name: "重要资料", userName: "spongebob", updateTime: "2018-04-12", type: '文件夹'  ,needpower:2},
          { name: "重要资料", userName: "spongebob", updateTime: "2018-04-12", type: '文件夹'  ,needpower:2},
          { name: "重要资料", userName: "spongebob", updateTime: "2018-04-10", type: '文件夹'  ,needpower:2},
          { name: "重要资料", userName: "forg", updateTime: "2018-04-08", type: '文件夹'  ,needpower:2},
          { name: "重要资料", userName: "forg", updateTime: "2018-04-07", type: '文件夹'  ,needpower:2},
        ],
        [
          { name: "机密文件", userName: "spongebob", updateTime: "2018-04-11", type: '文件夹'  ,needpower:3},
          { name: "机密文件", userName: "spongebob", updateTime: "2018-04-08", type: '文件夹'  ,needpower:3},
          { name: "机密文件", userName: "forg", updateTime: "2018-04-07", type: '文件夹'  ,needpower:3},
          { name: "机密文件", userName: "forg", updateTime: "2018-04-07", type: '文件夹'  ,needpower:3},
        ]
      ],
      normalData: [
